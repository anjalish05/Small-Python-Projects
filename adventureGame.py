...
if answer == "left":
    ...
    answer = input("You come to a bridge, it looks wobbly, do you want to cross it or head back? (cross/head back): ").lower()
    if answer == "cross":
        answer = input("You cross the bridge and meet a stranger. Do you tal kto them? (Yes/No): ").lower()
        if answer == 'yes':
